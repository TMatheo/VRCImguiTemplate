...
namespace Idk.GUI
{
    internal class GUIStyle
    {
        public static void RenderMenu()
        {
            ...
            style.Colors[(int)ImGuiCol.TitleBgCollapsed] = new Vector4(0.00f, 0.00f, 0.00f, 0.81f);
            ...
            style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.54f, 0.57f, 0.51f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.35f, 0.42f, 0.31f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.NavWindowingHighlight] = new Vector4(1.00f, 1.00f, 1.00f, 1.00f);
            style.Colors[(int)ImGuiCol.NavWindowingDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 1.00f);
            style.Colors[(int)ImGuiCol.ModalWindowDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 1.00f);
